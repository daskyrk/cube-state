...
export type EnhanceEffectFn<S> = (meta: EffectMeta<S>, ...args: any) => Promise<any>

export type EffectMeta<S> = {
...
export type EffectFn<F> = F extends (meta: infer U, ...args: infer A) => Promise<any> ? {
  (...args: A): ReturnType<F>
} : unknown;
